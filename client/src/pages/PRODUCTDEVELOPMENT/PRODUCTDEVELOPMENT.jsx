...
const PRODUCTDEVELOPMENT = () => {
    ...
    const { isLoading, isError, error } = useQuery({
        ...
        queryFn: () => getCanvasData({ projectId, canvasName: 'productdevelopment' }),
        staleTime: Infinity,
    ...
    const mutation = useMutation(
        {
            mutationKey: ['project-productdevelopment-update'],
            mutationFn: () => updateCanvasData({ projectId, canvasName: 'productdevelopment', canvas }),
            staleTime: Infinity,
