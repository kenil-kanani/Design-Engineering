...
const BUSINESSMODEL = () => {
    ...
    const { isLoading, isError, error } = useQuery({
        queryKey: ['project-businessmodel-get'],
        queryFn: () => getCanvasData({ projectId, canvasName: 'businessmodel' }),
        staleTime: Infinity,
    ...
    const mutation = useMutation(
        {
            mutationKey: ['project-businessmodel-update'],
            mutationFn: () => updateCanvasData({ projectId, canvasName: 'businessmodel', canvas }),
            staleTime: Infinity,
